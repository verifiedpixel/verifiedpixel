  ...
  return [
    ...
    function MultiActionBarController(
      ...
      this.download = function() {
        ...
        api.save('verifiedpixel_zip', {"items" : items_ids})
            .then(function(result) { ctrl.download_queue.push(result._id); });
      };
      ...
      $scope.$on('vpp::multi.reset', function(_e) { multi.reset(); });
      ...
      this.send = function() { return send.all(multi.getItems()); };

      this.sendAs = function() { return send.allAs(multi.getItems()); };
